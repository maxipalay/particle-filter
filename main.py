...
def initialize_random_state(x0=0, y0=0, h0=0):
    ...
    state = [[x0+sample(SIGMA_INITIAL_STATE), y0+sample(SIGMA_INITIAL_STATE), h0+sample(SIGMA_INITIAL_STATE)] for _ in range(N_PARTICLES)]
    return state
...
if __name__=="__main__":
    ...
    x0, y0, h0 = dl.ground_truth[0,du.GT_X], dl.ground_truth[0,du.GT_Y], dl.ground_truth[0,du.GT_H]
    ...
    # instance plotter
    plot = plotting.Plotter(N_PARTICLES, dl.landmarks, plotting.PLOT_REALTIME_MEAN)
